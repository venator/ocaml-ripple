...
(* OASIS_START *)
(* DO NOT EDIT (digest: 86e873ae3bd6e3418c4fc8101cc6ffec) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors =
            [
               "Guillem Rieu <guillem@luminar.fr>";
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ripple"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "transactions.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "y\182s\129f\236?\023\011\248h\224\225\198\200\017";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
